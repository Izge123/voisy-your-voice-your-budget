  ...
  const faqs = [
    {
      ...
      answer: "30 дней полного доступа ко всем функциям: голосовой ввод, сплит-транзакции, AI-консультант, аналитика. Карта не нужна для активации — просто зарегистрируйся и пользуйся."
    },
    {
    ...
    <section id="faq" className="w-full py-16 md:py-24 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-muted-foreground font-inter mb-12 md:mb-16 max-w-2xl mx-auto">
          Не нашел ответ? Напиши нам на hello@kapitallo.com
        </p>
