...
const UseCases = () => {
  const useCases = [{
    ...
    features: ["Голосовой ввод в один тап", "AI автоматически распознаёт категорию", "Сплит-транзакции: «2000 — такси 500, кофе 200»"],
    ...
    features: ["Никаких форм и ручного ввода", "Автокатегоризация расходов", "Мгновенная аналитика по периодам"],
    ...
    features: ["AI-чат с персональными советами", "Понятная аналитика без графиков Excel", "Гибкие категории под твой стиль жизни"],
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Tabs defaultValue="forgetful" className="max-w-5xl mx-auto">
          <TabsList className="grid w-full grid-cols-3 mb-8 h-auto p-1 bg-muted">
            ...
            return <TabsTrigger key={useCase.id} value={useCase.id} className="flex flex-col sm:flex-row items-center gap-2 py-3 data-[state=active]:bg-background">
          ...
          {useCases.map(useCase => {
          const Icon = useCase.icon;
          return <TabsContent key={useCase.id} value={useCase.id} className="mt-0">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    ...
                    <div>
                      ...
                      <ul className="space-y-3">
                        {useCase.features.map((feature, index) => <li key={index} className="flex items-start gap-3">
